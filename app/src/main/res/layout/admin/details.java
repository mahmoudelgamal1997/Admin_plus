...
ListView listView;
    ...
    listView=(ListView)findViewById(R.id.listView);
        ...
        FirebaseListAdapter<com.example2017.android.admin.item_in_deatails_listview> firebaseListAdapter=new FirebaseListAdapter<com.example2017.android.admin.item_in_deatails_listview>(
                this,
                com.example2017.android.admin.item_in_deatails_listview.class,
                R.layout.item_listview,
                information
        ) {
            @Override
            protected void populateView(View v, com.example2017.android.admin.item_in_deatails_listview model, int position)
            {
